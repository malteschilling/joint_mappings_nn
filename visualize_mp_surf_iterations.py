"""
Visualization of NN training data.
...
py.savefig("Figures/MSE_Learning_NNsize.pdf")
...
py.savefig("Figures/MSE_Architecture.pdf")
...
py.savefig("Figures/MSE_Learning_Generalization.pdf")
plt.show()